...
export const MOCK_HOMEWORK: HomeworkAssignment[] = [
  { id: 'hw1', class_name: 'JHS 3A', subject: 'Mathematics', title: 'Exercises 14.1–14.4: Fractions & Decimals', description: 'Complete all questions in the textbook. Show working for each step.', due_date: '2026-05-26', teacher_name: 'Mrs. Adjoa Koomson', submission_count: 24, total_students: 27, created_at: '2026-05-21T08:30:00Z' },
  { id: 'hw2', class_name: 'JHS 3A', subject: 'English Language', title: 'Essay: My Community', description: 'Write a 2-page essay on your community. Include at least 3 main points. Due by 3pm.', due_date: '2026-05-27', teacher_name: 'Mr. Kofi Amponsah', submission_count: 25, total_students: 27, created_at: '2026-05-21T09:00:00Z' },
  { id: 'hw3', class_name: 'JHS 3A', subject: 'Integrated Science', title: 'Diagram: Types of Soil', description: 'Draw and label the three types of soil found in Ghana (clay, sandy, loam). Use colored pencils.', due_date: '2026-05-28', teacher_name: 'Mrs. Adjoa Koomson', submission_count: 22, total_students: 27, created_at: '2026-05-21T10:00:00Z' },
  { id: 'hw4', class_name: 'JHS 3A', subject: 'Social Studies', title: "Ghana's Historical Periods", description: 'Research and write notes on Pre-Colonial, Colonial, and Post-Colonial Ghana. 1 page minimum.', due_date: '2026-05-29', teacher_name: 'Mrs. Adjoa Koomson', submission_count: 20, total_students: 27, created_at: '2026-05-21T11:00:00Z' },
  { id: 'hw5', class_name: 'JHS 3A', subject: 'RME', title: 'World Religions Comparison Chart', description: 'Create a comparison chart of Islam, Christianity, and Traditional Religion. Include founder, holy book, core beliefs.', due_date: '2026-05-30', teacher_name: 'Mrs. Adjoa Koomson', submission_count: 18, total_students: 27, created_at: '2026-05-21T12:00:00Z' },
  { id: 'hw6', class_name: 'Primary 5B', subject: 'Mathematics', title: 'Multiplication Tables 1–12', description: 'Practice and memorise all tables. You will be quizzed on Friday.', due_date: '2026-05-26', teacher_name: 'Miss Yaa Owusu', submission_count: 31, total_students: 32, created_at: '2026-05-21T08:00:00Z' },
]

export const MOCK_LESSON_PLANS: LessonPlan[] = [
  { id: 'lp1', class_name: 'JHS 3A', subject: 'Mathematics', strand: 'Number and Algebra', sub_strand: 'Fractions & Decimals', week_number: 14, objectives: 'Students will be able to add, subtract, multiply and simplify fractions.', content: 'Starter (10 min): 5 warm-up problems on fraction basics. Main (25 min): Guided practice with worked examples. Students solve problems in pairs. Group work (10 min): peer teaching in groups of 4. Plenary (5 min): exit ticket on mixed operations.', experiment: 'Pizza slicing activity: use actual pizza or paper circles to demonstrate fraction addition.', teacher_name: 'Mrs. Adjoa Koomson', is_published: true, created_at: '2026-05-15T08:00:00Z' },
  { id: 'lp2', class_name: 'JHS 3A', subject: 'Integrated Science', strand: 'Earth & Environment', sub_strand: 'Soil Types in Ghana', week_number: 14, objectives: 'Identify and distinguish between clay, sandy and loam soils.', content: 'Starter: Show pictures of different soil types. Main: Students perform soil texture test using water. Discussion on farming implications for Ghanaian agriculture. Practical: Soil sample observation and classification.', experiment: 'Jar test: layer soil with water to observe settling patterns (clay settles slower than sand).', teacher_name: 'Mrs. Adjoa Koomson', is_published: true, created_at: '2026-05-15T09:00:00Z' },
  { id: 'lp3', class_name: 'JHS 3A', subject: 'English Language', strand: 'Comprehension & Expression', sub_strand: 'Creative Writing', week_number: 14, objectives: 'Students will write descriptive essays using vivid language.', content: 'Starter: Read sample descriptive essay. Discuss sensory words. Main: Brainstorm ideas. Model writing. Students draft their own 2-page essay. Share in pairs.', teacher_name: 'Mr. Kofi Amponsah', is_published: true, created_at: '2026-05-15T10:00:00Z' },
  { id: 'lp4', class_name: 'JHS 3A', subject: 'Social Studies', strand: 'Ghana Studies', sub_strand: 'Historical Periods', week_number: 14, objectives: "Understand Ghana's Pre-Colonial, Colonial, and Post-Colonial history.", content: 'Timeline activity: 1500-present. Pre-Colonial: kingdoms (Ashanti, Fante). Colonial: 1471-1957. Post-Colonial: Independence to present. Class discussion on economic & social changes.', teacher_name: 'Mrs. Adjoa Koomson', is_published: true, created_at: '2026-05-16T08:00:00Z' },
  { id: 'lp5', class_name: 'JHS 3A', subject: 'RME', strand: 'Comparative Religion', sub_strand: 'World Religions', week_number: 14, objectives: 'Compare core beliefs and practices of major world religions.', content: 'Compare Islam, Christianity, Traditional Religion. Discuss: founders, holy books, daily practices, festivals. Respectful dialogue. Students create comparison chart.', teacher_name: 'Mrs. Adjoa Koomson', is_published: true, created_at: '2026-05-16T09:00:00Z' },
  { id: 'lp6', class_name: 'Primary 5B', subject: 'Mathematics', strand: 'Number & Operations', sub_strand: 'Multiplication', week_number: 14, objectives: 'Fluency with multiplication tables 1-12.', content: 'Daily chants: 2x, 5x, 10x tables. Arrays & equal groups activities. Rhymes & songs. Games: multiplication bingo, skip counting races.', teacher_name: 'Miss Yaa Owusu', is_published: true, created_at: '2026-05-16T10:00:00Z' },
]
